...
<div class="col-sm-2 team-member animated fadeInDown an-d-3" >
<img src="images/mir.jpg" alt="">
<strong>Mir Adil Rashid</strong>
<span>Chief Executive Officer</span>
</div>
<div class="col-sm-2 team-member animated fadeInDown an-d-4" >
<img src="images/afaq.jpg" alt="">
<strong>Muahammad Afaq Khan</strong>
<span>Director</span>
</div>
<div class="col-sm-2 team-member animated fadeInDown an-d-5" >
<img src="images/abrar.jpg" alt="">
<strong>Abrar Ahmed Mir</strong>
<span>Director</span>
</div>
...
<div class="col-sm-2 team-member animated fadeInRight an-d-8" >
...
<div class="col-sm-2 team-member animated fadeInUp an-d-2" data-animate="fadeInRight" style="margin-left:300px;">
<img src="images/mir.jpg" alt="">
<strong>Mir Adil Rashid</strong>
<span>Chief Executive Officer</span>
...
<div class="col-sm-2 team-member animated fadeInUp an-d-2" data-animate="fadeInRight" style="    margin-left: 200px;">
<img src="images/mir.jpg" alt="">
<strong>Mir Adil Rashid</strong>
<span>Chief Executive Officer</span>

</div>
<div class="col-sm-2 team-member   animated fadeInUp an-d-3">
<img src="images/013.jpg" alt="">
<strong>Raza Inam</strong>
<span>(CFA) Acting Head of Research</span>
...
<span>Head of Equities</span>

</div>
<div class="col-sm-2 team-member  animated fadeInLeft an-d-5" >
<img src="images/003.jpg" alt="">
<strong>Wamiq Sakrani</strong>
...
<div id="con"  style="margin:auto; display:none;" class="col-sm-6">

<select  id="crf"  name="crf" class="form-control test">

<option  value="">Select Fund</option>

<option  id="con1"></option>
<option  id="con2"></option>
<option  id="con3"></option>
</select>
</div>
<br>
<div id="isl" style="margin:auto; display:none;" class="col-sm-6">
<select  id="irf"   name="irf" class="form-control test">
<option  value="">Select Fund</option>

<option  id="isl1"></option>
<option  id="isl2"></option>
<option  id="isl3"></option>
</select>
</div>
...
<br>
<input id="risk" required name="decision" value="Or Choose Another Product at My Own Risk"  type="radio" style="width:30px; height:20px; border:2px solid #01a896; margin-top:20px;">
Or Choose Another Product at My Own Risk
</p>
