...
$arr = array (
  ...
  'OverseasMailingAddress' => $fatca_details->co_ma == 'yes' ? true : false, // data type should be string nullable
  'OverseasPhoneNumber' => $fatca_details->co_mp == 'yes' ? true : false, // data type should be string nullable
  'AttorneyAddress' => $fatca_details->attor == 'yes' ? true : false,
  ...
  'OccupationName' => $customer_details->occupation,
  ...
  'MaritalStatus' => $customer_details->marital_status != 'Single' ?  true : false,
...
$res = json_decode($response);
      ...
      echo "cURL Error #:" . $err;
        ...
        list($msg,$data) = (is_object($res)) ? ['err',$res] : ['msg',$res];
