  ...
  public function push_to_crm(Request $request){
    ...
    if($customer_details->zakat_certificate != 'no_image.png'){
      ...
      $arr = array (
        ...
        'DAOFBankName' => 'sample string 23',
        'DAOFBankNameInvestment' => 'sample string 24',
        'FundName' => 'sample string 25',
        'AmountInWords' => 'sample string 26',
        'AmountRs' => 27.0,
        'FrontEndLoad' => 'sample string 28',
        'PaymentMode' => 'sample string 29',
